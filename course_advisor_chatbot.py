...
answer_prompt = ChatPromptTemplate.from_messages([
    ("system",
     ...
     -When mentioning a module, always state the title of the parent course first, then mention the module.
     -Format all responses in neat, well-structured markdown.
     """
    ),
